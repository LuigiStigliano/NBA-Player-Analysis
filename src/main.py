...
# MODIFICA: Importazione di add_per_game_metrics
...
def run_pipeline():
    ...
    # MODIFICA: Aggiunta del calcolo delle metriche per-game
    ...
    print(f"Punteggio di validità finale (Silhouette Score): {silhouette_score:.3f}")
    ...
    # MODIFICA: Passaggio del DataFrame con le metriche complete per il reporting
